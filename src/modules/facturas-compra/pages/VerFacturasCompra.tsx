/**
 * Página que muestra el listado completo de facturas de compra en una tabla.
...
import { getAllFacturasCompra }          from '../'
...
interface ColumnaConfig {
  header: string
  key: keyof FacturaCompraCabecera
...
export default function VerFacturasCompra() {
  const { datos: facturas, error, cargando } = useListado(getAllFacturasCompra)
  ...
  if (facturas.length === 0) return (
    <p className="text-center text-gray-400 p-6">No hay facturas de compra registradas</p>
  )

  return (
    <div className="p-6 w-full">
      <h2 className="text-gray-300 text-2xl font-bold mb-6 text-center">Facturas de Compra</h2>
