/**
 * Componente de presentación que muestra los datos de un proveedor
...
const CAMPOS: CampoConfig[] = [
  ...
  { label: 'Descripción',        key: 'descProveedor'},
  { label: 'Razón Social',       key: 'razonSocial'  },
  { label: 'CIF',                key: 'cifProveedor' },
  // Dirección
  ...
  { label: 'Cuenta Contable',    key: 'ccProveedor'  },
...
export function ProveedorDetail({ proveedor }: ProveedorDetailProps) {
  return (
        ...
        <Fragment key={key}>
          ...
          {multiline ? (
            <textarea
              ...
              readOnly
              value={proveedor[key] != null ? String(proveedor[key]) : ''}
            />
          ) : (
            <input
              id={key}
